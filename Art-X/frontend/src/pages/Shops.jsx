  ...
  return (
    <div>
      ...
      <section className='bg-[url("http://localhost:3000/images/banner/shop.png")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
        <div className="absolute left-0 top-0 w-full h-full bg-[#312f2f8a]">
        ...
        <div className="w-[85%] md:w-[80%] sm:w-[90%] lg:w-[90%] h-full mx-auto">
          <div className={` md:block hidden ${!filter ? "mb-6" : "mb-0"} `}>
            <button
              ...
              className="text-center w-full py-2 px-3 bg-stone-600 text-white"
            >
              Filter Painting
            </button>
          </div>
          ...
          <div className="w-full flex flex-wrap">
            ...
            >
              <h2 className="text-3xl font-bold mb-3 text-stone-600">
                Category{" "}
              </h2>
              <div className="py-2">
                {categorys.map((c, i) => (
              ...
              <div className="py-2 flex flex-col gap-5">
                ...
                <Range
                  ...
                  renderTrack={({ props, children }) => (
                    <div
                      {...props}
                      className="w-full h-[5px] bg-slate-200 rounded-full cursor-pointer"
                    >
                      {children}
                    </div>
                  )}
                  renderThumb={({ props }) => (
                    <div
                      className="w-[13px] h-[13px] bg-stone-500 rounded-full"
                      {...props}
                    />
                  )}
                />
