                ...
                <div className="bg-white p-6 shadow-sm rounded-md">
                      ...
                      <form onSubmit={save}>
                        ...
                        <div className="flex md:flex-col md:gap-2 w-full gap-5 text-slate-600">
                          ...
                          <div className="flex flex-col gap-1 mt-7 mb-2 w-full">
                            <button className="px-3 py-[6px] rounded-sm hover:bg-stone-900   hover:shadow-lg bg-stone-500 text-white">
                              Save Change{" "}
                            </button>
                          </div>
                        </div>
                  ...
                  {res && (
                    <div className="flex flex-col gap-1">
                      ...
                      <p>
                        <span className="bg-stone-200 text-stone-800 text-sm font-medium mr-2 px-2 py-1 rounded">
                          Home
                        </span>
                        <span>
                          {state.phone} {state.address} {state.state}{" "}
                      ...
                      <p className="text-slate-600 text-sm">
                        Email To adityakumar@gmail.com
                      </p>
                    </div>
                  )}
                </div>
                        ...
                        <div className="flex sm:w-full gap-2 w-7/12">
                          <div className="flex gap-2 justify-start items-center">
                            <img
                              ...
                              src={`http://localhost:3000/images/paintings/${
                                i + 1
                              }.jpg`}
                              alt=""
                            />
                            <div className="pr-4 text-slate-600">
                              ...
                              <span className="text-sm">Type: Oil </span>
                            </div>
                          </div>
                        </div>
